...
>      2. 文件格式：应用程序
>
>   3. 将 mpv multiple 拖入应用程序，修改视频文件的默认打开方式
...
##### [Fader 单独控制每个 App 的音量](https://github.com/pantafive/fader)
...
1. 设置项
   ...
   ![image-20260902174503285](https://raw.githubusercontent.com/jiangsai0502/PicBedRepo/master/img/202609021745365.png)
...
* host 完整内容
  ...
  # 屏蔽 iStat Menus 更新提示
  127.0.0.1 updates.istatmenus.app
  ::1 updates.istatmenus.app
  
  # 屏蔽 Parallels Desktop 更新提示
  ...
  # 屏蔽 Sogou 更新提示
  0.0.0.0 macime.sogou.com
  0.0.0.0 get.sogou.com
  0.0.0.0 p3p.sogou.com
  0.0.0.0 ping.pinyin.sogou.com
  0.0.0.0 cdn2.ime.sogou.com
  
  # 屏蔽 JianYing 更新提示
  0.0.0.0 frontier100-normal.zijieapi.com
  0.0.0.0 lumi-effect.zijieapi.com
  0.0.0.0 feed-api.capcutapi.com
  0.0.0.0 feed-api.capcut.com
